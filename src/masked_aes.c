...
void static inline add_round_key_8(uint16_t state[8][8], uint16_t rkey[8][8])
{
    masked_xor_8(state[0], rkey[0], state[0]);
    masked_xor_8(state[1], rkey[1], state[1]);
    masked_xor_8(state[2], rkey[2], state[2]);
    masked_xor_8(state[3], rkey[3], state[3]);
    masked_xor_8(state[4], rkey[4], state[4]);
    masked_xor_8(state[5], rkey[5], state[5]);
    masked_xor_8(state[6], rkey[6], state[6]);

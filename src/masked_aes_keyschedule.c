...
void masked_aes_keyschedule128(uint16_t key[8][8], uint16_t masked_bs_rkeys[11][8][8], uint32_t fresh_randoms[3200])
{
    ...
    masked_aes_sbox_8(masked_bs_rkeys[1], &(fresh_randoms[0]));
    ...
    masked_aes_sbox_8(masked_bs_rkeys[2], &(fresh_randoms[320]));
    // RCON1 = 0x02
    ...
    masked_aes_sbox_8(masked_bs_rkeys[3], &(fresh_randoms[640]));
    // RCON2 = 0x04
    ...
    masked_aes_sbox_8(masked_bs_rkeys[4], &(fresh_randoms[960]));
    // RCON3 = 0x08
    ...
    masked_aes_sbox_8(masked_bs_rkeys[5], &(fresh_randoms[1280]));
    // RCON4 = 0x10
    ...
    masked_aes_sbox_8(masked_bs_rkeys[6], &(fresh_randoms[1600]));
    // RCON5 = 0x20
    ...
    masked_aes_sbox_8(masked_bs_rkeys[7], &(fresh_randoms[1920]));
    // RCON6 = 0x40
    ...
    masked_aes_sbox_8(masked_bs_rkeys[8], &(fresh_randoms[2240]));
    // RCON7 = 0x80
    ...
    masked_aes_sbox_8(masked_bs_rkeys[9], &(fresh_randoms[2560]));
    // RCON8 = 0x1B
    ...
    masked_aes_sbox_8(masked_bs_rkeys[10], &(fresh_randoms[2880]));
    // RCON9 = 0x36

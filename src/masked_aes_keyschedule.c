...
// Each masked_aes_sbox_8 is done on the whole state instead of ony one column
void masked_aes_keyschedule128(uint16_t key[8][8], uint16_t masked_bs_rkeys[11][8][8], void (*rng_fill)(char *, int))
{
    ...
    masked_aes_sbox_8(masked_bs_rkeys[1], rng_fill);
    ...
    masked_aes_sbox_8(masked_bs_rkeys[2], rng_fill);
    // RCON1 = 0x02
    ...
    masked_aes_sbox_8(masked_bs_rkeys[3], rng_fill);
    // RCON2 = 0x04
    ...
    masked_aes_sbox_8(masked_bs_rkeys[4], rng_fill);
    // RCON3 = 0x08
    ...
    masked_aes_sbox_8(masked_bs_rkeys[5], rng_fill);
    // RCON4 = 0x10
    ...
    masked_aes_sbox_8(masked_bs_rkeys[6], rng_fill);
    // RCON5 = 0x20
    ...
    masked_aes_sbox_8(masked_bs_rkeys[7], rng_fill);
    // RCON6 = 0x40
    ...
    masked_aes_sbox_8(masked_bs_rkeys[8], rng_fill);
    // RCON7 = 0x80
    ...
    masked_aes_sbox_8(masked_bs_rkeys[9], rng_fill);
    // RCON8 = 0x1B
    ...
    masked_aes_sbox_8(masked_bs_rkeys[10], rng_fill);
    // RCON9 = 0x36
